...
def combined_loss(gen_frames, gt_frames, adv_windowed_loss, lam_adv=1, lam_lp=1, lam_gdl=1, l_num=2, alpha=2):
    """
    ...
    @param adv_windowed_loss: A float containing adversarial windowed loss.
    ...
    if c.ADVERSARIAL: loss += lam_adv * adv_windowed_loss
